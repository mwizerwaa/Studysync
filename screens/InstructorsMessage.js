...
const InstructorsMessage = () => {
  ...
  return (
    <LinearGradient
      style={styles.instructorsMessage}
    ...
    >
      ...
      />
      <View style={[styles.footer, styles.footerhomePosition]}>
        <View style={[styles.footerhome, styles.footerhomePosition]}>
          <Image
            style={[styles.footerhomeBackgroundIcon, styles.footerhomePosition]}
            contentFit="cover"
          ...
          <View style={[styles.footeroff2, styles.footeroffPosition]}>
            ...
            <Image
              ...
              contentFit="cover"
              source={require("../assets/iconfooteraccountoff9.png")}
            />
          </View>
        </View>
      </View>
      <View style={[styles.buttons, styles.buttonsLayout]}>
        <View style={[styles.curriculum, styles.rectangleBg]}>
          ...
          <Image
            style={styles.heroiconsUserGroup1}
            contentFit="cover"
            source={require("../assets/heroiconsusergroup-11.png")}
          />
        </View>
        <Pressable
          style={[styles.resources, styles.footerhomePosition]}
          onPress={() => navigation.navigate("Messages")}
        >
          <View style={styles.rectanglePosition} />
          <Text style={[styles.about, styles.aboutTypo]}>Messages</Text>
          <Image
            style={styles.tablerMessageCircleUser1Icon}
            contentFit="cover"
            source={require("../assets/tablermessagecircleuser-1.png")}
          />
        </Pressable>
        <Pressable
          style={[styles.resources1, styles.resourcesShadowBox]}
          onPress={() => navigation.navigate("Messages")}
        >
          <View style={styles.rectanglePosition} />
          <Text style={[styles.about1, styles.aboutTypo]}>{`Instructor
Messages`}</Text>
        </Pressable>
      </View>
      <Pressable
...
export default InstructorsMessage;
